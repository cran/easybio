---
title: "Example Workflow for Bulk RNA-seq Analysis with limma-voom"
author: "[cw](https://cying.org)"
date: "`{r} Sys.Date()`"
output: html
vignette: >
  %\VignetteEngine{litedown::vignette}
  %\VignetteIndexEntry{Example Workflow for Bulk RNA-seq Analysis with limma-voom}
...
![Filter](./limmaFilter.png)


![Normalization](./limmaNorm.png)
...
```{r,fig.width=4, fig.height=2.7, echo=TRUE}
fgseaRes <- fgsea(
